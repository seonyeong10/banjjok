...
<%@ include file="../../include/top.jsp"%>
	<div class="contentWrap">
		...
		<div class="content">
			...
			<form action="reserveAct" method="post" name="frm">
								...
								<ul>
									<li>
										<label class="box-radio-input">
											<input type="radio" name="reservTime" value="10:00" onclick="getId('${desn.desnId}');" /><span >10:00</span>
										</label>
									</li>
									<li>
										<label class="box-radio-input">
											<input type="radio" name="reservTime" value="11:00" onclick="getId('${desn.desnId}');"/><span>11:00</span>
										</label>
									</li>
									<li>
										<label class="box-radio-input">
											<input type="radio" name="reservTime" value="12:00" onclick="getId('${desn.desnId}');"/><span>12:00</span>
										</label>
									</li>
									<li>
										<label class="box-radio-input">
											<input type="radio" name="reservTime" value="13:00" onclick="getId('${desn.desnId}');"/><span>13:00</span>
										</label>
									</li>
									<li>
										<label class="box-radio-input">
											<input type="radio" name="reservTime" value="14:00" onclick="getId('${desn.desnId}');" /><span>14:00</span>
										</label>
									</li>
									<li>
										<label class="box-radio-input">
											<input type="radio" name="reservTime" value="15:00" onclick="getId('${desn.desnId}');"/><span>15:00</span>
										</label>
									</li>
									<li>
										<label class="box-radio-input">
											<input type="radio" name="reservTime" value="16:00" onclick="getId('${desn.desnId}');"/><span>16:00</span>
										</label>
									</li>
									<li>
										<label class="box-radio-input">
											<input type="radio" name="reservTime" value="17:00" onclick="getId('${desn.desnId}');"/><span>17:00</span>
										</label>
									</li>
								</ul>
							</div>
